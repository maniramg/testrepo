...
$plugin_info = array(
	...
	'load_factory_modules' => array(
		array( 'libs/factory/bootstrap', 'factory_bootstrap_428', 'admin' ), // Модуль позволяет использовать различные js виджеты и стили оформление форм.
		array( 'libs/factory/forms', 'factory_forms_425', 'admin' ), // Модуль позволяет быстро создавать формы и готовые поля настроек
		array( 'libs/factory/pages', 'factory_pages_427', 'admin' ), // Модуль позволяет создавать страницы плагина, в том числе шаблонизированные страницы
		array( 'libs/factory/freemius', 'factory_freemius_115', 'all' ), // Модуль для работы с freemius.com, содержит api библиотеку и провайдеры для премиум менеджера
		array( 'libs/factory/adverts', 'factory_adverts_107', 'admin') // Модуль для показа рекламы в админпанели Wordpress, вся реклама вытягивается через API Creative Motion
	)
);

$wis_compatibility = new Wbcr_Factory427_Requirements( __FILE__, array_merge( $plugin_info, array(
